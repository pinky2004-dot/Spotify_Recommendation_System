...
df = pd.read_csv('/content/drive/MyDrive/AI4ALL/project/cleaned_transformed_spotify_dataset.csv')

# Define the recommendation function
def recommend_song(selected_song, df):
    song_index = df[df['Track Name'] == selected_song].index[0]
    song_features = df.drop(['Track Name', 'Cluster', 'Cluster Label'], axis=1).iloc[song_index]
